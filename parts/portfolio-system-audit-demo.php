...
/**
 * Live editor experience audit demo.
 *
    ...
    <div class="fu-case-section__inner container container--readable">
        <div
            ...
            <div class="fu-portfolio-audit__header">
                ...
                <h2 class="fu-section-heading fu-section-heading--compact" id="portfolio-system-audit-heading">Live Editor Experience Audit</h2>
