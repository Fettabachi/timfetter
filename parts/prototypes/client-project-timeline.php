...
<div class="fu-client-timeline-demo" data-client-project-timeline>
    <!-- Portfolio title/intro is rendered by the main template. -->
    ...
    <div class="fu-prototype-note">
        <p><strong>Note:</strong> This is a front-end prototype for demonstration purposes only. It is not a production WordPress block or plugin.</p>
    </div>
</div>