...
class HandleOnPageLinks {
  ...
  getTarget(hash) {
    ...
    return document.querySelector(hash) || document.querySelector(`[name="${CSS.escape(id)}"]`);
  }
  isSamePageLink(link) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunktim_fetter_theme"] = globalThis["webpackChunktim_fetter_theme"] || [];
